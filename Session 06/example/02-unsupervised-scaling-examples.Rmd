...
data_corpus_irishbudget2010 <- corpus_subset(data_corpus_irishbudgets, year == 2010)

# making prettier document names
docnames(data_corpus_irishbudget2010)  <- paste(
  docvars(data_corpus_irishbudget2010, "namefirst"), 
  docvars(data_corpus_irishbudget2010, "namelast"), 
...
To explore an unsupervised approach to ideological scaling applied to tweets by Members of Congress. Can we recover a latent ideological dimension based on the text of their tweets?
