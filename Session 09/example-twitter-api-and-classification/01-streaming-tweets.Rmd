...
Next, we create a token object and lookup a user to see whether the access works:

```{r}
token <- create_token(consumer_key = auth$consumer_key, 
                      consumer_secret = auth$consumer_secret,
                      access_token = auth$access_token,
                      access_secret = auth$access_token_secret)

# Test whether access works
lookup_users(token = token, "zeppelin")
```
