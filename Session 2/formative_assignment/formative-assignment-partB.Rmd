...
Goig back to the dataset with tweets by Bernie Sanders, try to create a corpus and a document feature matrix. Think carefully through the different options (e.g. should you exclude stopwords?). Then, look at the 25 most frequent words. What do you learn?
