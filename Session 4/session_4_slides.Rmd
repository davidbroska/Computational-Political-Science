...
- This is why the model is called "naive": it assumes that seeing a word does change the probability of observing other words in a document. 
...
$$P(c_k|d)=P(c_k) \prod_{j}^{J} \frac{P(w_j|c_k)}{P(w_j)}$$
